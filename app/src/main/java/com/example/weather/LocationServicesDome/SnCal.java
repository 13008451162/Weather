...
public class SnCal {
    ...
    //    private String address = "湘水镇";  //需要搜索的地址
    private int digit = 2;      //需要搜索的行政区划显示子级级数

    /**
     * @param address = 需要查询的地址
     * @return 返回值为完整的Url, 可以直接访问
     * @throws UnsupportedEncodingException
     * @throws NoSuchAlgorithmException
     */
    public String GetUrlSn(String address) throws UnsupportedEncodingException,
        ...
        // 调用下面的MD5方法得到最后的sn签名
        LogUtil.v("UrlSn", Url + SnCal.MD5(tempStr));

        return Url + SnCal.MD5(tempStr);
    }
